...
const branches = [
  ...
  { name:'مكتب تنسيق الخرطوم', tag:'مكتب التنسيق', address:'شارع محمد نجيب، جنوب مركز السودان للعيون وشمال جهاز المغتربين، الخرطوم، السودان.', phone:'+249 900 740 720', hours:'السبت - الخميس: 8:00 ص - 4:00 م', maps:'https://maps.app.goo.gl/ZJmAdWEfLijREvKeA', embed:'https://maps.google.com/maps?q=Mohamed%20Najib%20Street,%20Khartoum,%20Sudan&t=&z=15&ie=UTF8&iwloc=&output=embed' }
];
...
const form = (compact = false) => `<form class="lead-form ${compact ? 'compact' : ''}" data-lead-form novalidate>
  <div class="success-message" hidden>${icon('shield',19)} سيتم تسجيل طلبك. وسنتواصل معك خلال 24 ساعة.</div>
